...
const menuData = {
    refrescos: [
        { name: 'Agua', description: '330 ml', price: '1.50€', image: 'images/agua.jpg' },
        { name: 'Coca-Cola', description: '330 ml', price: '2.40€', image: 'images/coca.jpg' },
        { name: 'Coca-Cola Zero', description: '330 ml', price: '2.40€', image: 'images/cocazero.jpg' },
        { name: 'Fanta Limón', description: '330 ml', price: '2.40€', image: 'images/fantalimon.jpg' },
        { name: 'Fanta Naranja', description: '330 ml', price: '2.40€', image: 'images/fantanaranja.jpg' },
        { name: 'Sprite', description: '330 ml', price: '2.40€', image: 'images/sprite.jpg' },
        { name: 'Nestea Maracuyá', description: '330 ml', price: '2.40€', image: 'images/nestea.jpg' },
        { name: 'Aquarius', description: '330 ml', price: '2.40€', image: 'images/aquarius.jpg' },
        { name: 'Schweppes Tónica', description: '330 ml', price: '2.40€', image: 'images/tonica.jpg' },
        { name: 'Monster Energy', description: '500 ml', price: '3.00€', image: 'images/monster.jpg' },
        { name: 'Monster Energy Ultra', description: '500 ml', price: '3.00€', image: 'images/monsterblanco.jpg' },
        { name: 'Monster Energy Mango Loco', description: '500 ml', price: '3.00€', image: 'images/monstermango.jpg' },
        { name: 'Monster Energy Manzana Ultra Paradise', description: '500 ml', price: '3.00€', image: 'images/monstermanzana.jpg' },
        { name: 'Monster Energy Ultra Peachy Keen', description: '500 ml', price: '3.00€', image: 'images/monstermelocoton.jpg' },
        { name: 'Monster Energy Rehub Recover', description: '500 ml', price: '3.00€', image: 'images/rehab.jpg' },
    ],
    cervezas: {
        'De Barril': [
            { name: 'Kalimotxo', description: '500 ml', price: '3.50€', image: 'images/kalimotxo.jpg' },
            ...
            { name: 'Mahou Maestra Doble Lúpulo', description: 'Caña/Pinta', price: '2.20€/4.00€', image: 'images/maestra.jpg' },
            { name: 'Alhambra Roja', description: 'Caña/Pinta', price: '2.50€/4.50€', image: 'images/roja.jpg' },
            { name: 'Founders Porter', description: 'Caña/Pinta', price: '3.00€/5.50€', image: 'images/founders.jpg' },
            { name: 'Franziskaner', description: 'Caña/Pinta', price: '2.20€/4.00€', image: 'images/franziskaner.jpg' }
        ],
        'Embotelladas': [
...
copas: [
    // Licores y cremas (menor graduación)
    { name: 'Tía María', description: '', price: '', image: 'images/tiamaria.jpg' },
    { name: 'Malibú', description: '', price: '', image: 'images/malibu.jpg' },
    { name: 'Mangaroca Batida de Coco', description: '', price: '', image: 'images/mangaroca.jpg' },
    { name: 'Jagermeister', description: '', price: '', image: 'images/jager.jpg' },
    { name: 'Licor Cincuenta y Siete', description: '', price: '', image: 'images/cincuentaysiete.jpg' },
    { name: 'Cuaracao Blue', description: '', price: '', image: 'images/curacao.jpg' },
    { name: 'Colosal Peppermint', description: '', price: '', image: 'images/peppermint.jpg' },
    ...
    // Vodka
    { name: 'Kiroff Caramelo', description: '', price: '', image: 'images/eristoff.jpg' },
    { name: 'Kiroff Regaliz', description: '', price: '', image: 'images/kiroff.jpg' },
    { name: 'Absolut', description: '', price: '', image: 'images/absolut.jpg' },

    // Ginebra
    { name: 'Puerto de Indias Rosa', description: '', price: '', image: 'images/puerto.jpg' },
    { name: 'Puerto de Indias Verde', description: '', price: '', image: 'images/puerto.jpg' },
    ...
    // Tequila
    { name: 'Cachito Loco Tequila', description: '', price: '', image: 'images/cachito.jpg' },

    // Whisky
    { name: 'J&B', description: '', price: '', image: 'images/jb.jpg' },
    { name: "Dewar's White Label", description: '', price: '', image: 'images/dewars.jpg' },
    { name: 'Jameson Irish Whiskey', description: '', price: '', image: 'images/jameson.jpg' },
    { name: 'Four Roses', description: '', price: '', image: 'images/fourroses.jpg' },
    ...
    // Orujo / aguardiente
    { name: 'Quemeira', description:'', price:'', image:'images/quemeira.jpg' },

    // Absenta (mayor graduación)
    { name: 'Absenta Diable Azul', description: '', price: '', image: 'images/absentaa.jpg' },
    { name: 'Absenta Diable Negra', description: '', price: '', image: 'images/absentan.jpg' },
    { name: 'Absenta Diable Verde', description: '', price: '', image: 'images/absentav.jpg' },
]
...
const sectionInfo = {
    copas: ' Todas las copas normales a 6.00€, premium a 7.00€, y con Monster 7.50€. Chupitos a 1€.'
};
